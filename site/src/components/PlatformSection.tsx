            ...
            >
              <div className="flex items-center justify-between">
                ...
                <svg
                  ...
                  className={`text-white/60 transition-transform duration-200 ${expandedMobile === i ? 'rotate-180' : ''}`}
                >
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
          ...
          >
            ...
            {copiedDocker ? (
              ...
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white/60 group-hover:text-brand-lime shrink-0">
                <rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
                <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
              </svg>
            )}
          </button>
          <span className="text-xs text-white/60 font-sans">scratch-based, &lt; 20 MB</span>
        </div>
      </div>
    </section>
  )
